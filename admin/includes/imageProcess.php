...
# Constants
define(DEFAULT_IMAGE,'noimage.jpg');
$imagetype=$_GET['type'];
switch($imagetype)
{
	...
	case 'ezprints_cat' : define(IMAGE_BASE,DIR_EZPRINTS_CAT_IMAGES);break;
}
# Get image location
...
if($_REQUEST['type']=='proof'){
	...
	$watermark = imagecreatefromgif('../images/proof.gif');
	...
	if($new_height < $watermark_height || $new_width < $watermark_width)
	{
		...
		imageComposeAlpha( $image, $watermark, $dest_x, $dest_y, $new_watermark_width, $new_watermark_height );				
	}
	else
	{
