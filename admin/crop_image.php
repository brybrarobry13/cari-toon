<script type="text/javascript">
	function setFormValues(new_file_name)
	{
	 ...
	 if(new_file_name.substr(0,6)=='artist')
	 {
		window.opener.document.getElementById("cropped").value="yes";
	 }
...
print_r($_GET);*/
    ...
    $src = '../z_uploads/admin_artist_gallery/thumb_artist_images/temp_'.$_GET['image_name'];
	...
	$crop_target='../z_uploads/admin_artist_gallery/thumb_artist_images/th_'.$_GET['image_name'];
