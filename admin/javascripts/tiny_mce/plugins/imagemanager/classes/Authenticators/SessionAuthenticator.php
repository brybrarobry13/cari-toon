...
class Moxiecode_SessionAuthenticator extends Moxiecode_ManagerPlugin {
	...
	function onAuthenticate(&$man) {
		...
		//$_SESSION['MyIsLoggedInState'] = false; // make this true
		//$_SESSION['MyRootPath'] = "/home/syt/public_html/z_useruploads/evt1/tinymce/";
...
//echo "<br>Image path: " . $config['filesystem.rootpath'];
