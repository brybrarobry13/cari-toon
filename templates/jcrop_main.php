...
-->
<?php
		  $target_path="../z_uploads/artist_gallery/artist_images/for_crop_".$_GET['file_name'];
    ...
    <body bgcolor="#999">        
        <div style="background-color:#CCC;height: 600px;">
			<div style="float:left; padding-left:50px;">
				...
				<img src="../z_uploads/artist_gallery/artist_images/for_crop_<?=$_GET['file_name'] ?>"  id="cropbox1" style="float:left; padding-bottom:20px;" />
			...
			<div style="float:left; padding-left:30px;">
                ...
                <div style="overflow: hidden; width:204px; height:255px;" id="preview_crop">
                    <img id="preview" src="../z_uploads/artist_gallery/artist_images/for_crop_<?=$_GET['file_name'] ?>"  />
