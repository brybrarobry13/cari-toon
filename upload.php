...
<?php 
	//session_start();
    $destination_path = getcwd().DIRECTORY_SEPARATOR."z_uploads/artist_gallery/artist_images/";
  ...
  //$destination_path = "z_uploads/ok/"
   ...
   if(!in_array($file_ext,$ext_array))
   {
   ...
   else
	{
		    ...
		    $new_file_name_with_type=strtolower($_GET['type']."_".$_POST['sess_val']."_".$photoName2) ;
			  ...
			  else
			  {
					if($old_height > $old_width)
					{
					 ...
					 {	
					  ...
					  $crop_target="z_uploads/artist_gallery/artist_images/".$new_file_name_with_type;
					...
					if($old_width <= $old_height)
					{
					 ...
					 {	
					  ...
					  $crop_target="z_uploads/artist_gallery/artist_images/for_crop_".$new_file_name_with_type;
