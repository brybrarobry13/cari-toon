...
function FileProgress(file, targetID) {
	...
	//document.getElementById("progress_bottom").style.display = "block";
	...
	if (!this.fileProgressWrapper) {
		...
		this.progressBarBorder.className = "progressBarBorder";
		...
		progressTop.className = "progressTop_";
		
		var progressBottom = document.createElement("div");
		progressBottom.className = "progressBottom_";
		...
		this.progressBarBorder.appendChild(progressBar);
		
		this.fileProgressElement.appendChild(progressTop);
		this.fileProgressElement.appendChild(progressCancel);

		this.fileProgressElement.appendChild(this.progressBarBorder);
		this.fileProgressElement.appendChild(progressStatus);
		this.fileProgressElement.appendChild(progressText);
		
		this.fileProgressElement.appendChild(progressBottom);
...
FileProgress.prototype.reset = function () {
	...
	this.fileProgressElement.childNodes[2].childNodes[0].style.width = "0%";
...
FileProgress.prototype.setComplete = function () {
	...
	this.fileProgressElement.childNodes[2].childNodes[0].className = "";
	this.fileProgressElement.childNodes[2].childNodes[0].style.width = "";
	this.fileProgressElement.childNodes[2].style.visibility	="hidden";
	var oSelf = this;
...
FileProgress.prototype.toggleCancel = function (show, swfUploadInstance) {
	...
	if (swfUploadInstance) {
		...
		this.fileProgressElement.childNodes[1].onclick = function () {
			//this.fileProgressElement.childNodes[6].style.visibility = "hidden";
			swfUploadInstance.cancelUpload(fileID);
			return false;
		};
		
		
		this.fileProgressElement.childNodes[6].onclick = function () {
			swfUploadInstance.submitUpload();
			return false;
		};
