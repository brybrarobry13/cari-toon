...
//to submit the form on clicking continue
SWFUpload.prototype.submitUpload = function () {
	
	document.form_imgupload.submit();
...
SWFUpload.prototype.uploadSuccess = function (file, serverData, responseReceived) {
	...
	//alert(document.getElementById("upld").value);
	/*document.getElementById("progress_top").style.display = "none";
	document.getElementById("progress_bottom").style.display = "none";*/	
};
